      ...
      <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <motion.p
            ...
            className={`text-base sm:text-lg md:text-xl mb-4 ${theme === 'light' ? 'text-sky-700' : 'text-gray-400'}`}
          >
            <motion.span
              animate={{ 
                opacity: [0.5, 1, 0.5],
          ...
          <motion.h1
            ...
            className={`text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-bold mb-8 ${theme === 'light' ? 'text-slate-900' : ''}`}
          >
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h2 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 ${theme === 'light' ? 'text-slate-800' : 'text-white'}`}>
              Full Stack Developer
            </h2>
            <div className={`flex flex-wrap items-center justify-center gap-2 font-mono text-xs sm:text-sm md:text-base lg:text-base ${theme === 'light' ? 'text-sky-700' : 'text-gray-400'}`}>
          ...
          <motion.div
            ...
            className={`flex flex-col gap-2 mb-8 text-sm sm:text-sm md:text-base lg:text-base ${theme === 'light' ? 'text-sky-600' : 'text-gray-400'}`}
          >
          ...
          <motion.p
            ...
            className={`text-base sm:text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto mb-12 leading-relaxed ${theme === 'light' ? 'text-slate-700' : 'text-gray-300'}`}
          >
          ...
          >
            <motion.a
              href="#projects"
              className={`group relative px-6 sm:px-8 py-3 sm:py-4 rounded-full text-white font-semibold text-sm sm:text-base md:text-lg flex items-center gap-2 overflow-hidden ${
                theme === 'light'
            ...
            >
              <span className="relative z-10 flex items-center gap-2">
                ...
                <Briefcase size={18} className="block sm:hidden" />
                View Projects
              </span>
            ...
            <motion.a
              href="/resume.pdf"
              download
              className={`group px-6 sm:px-8 py-3 sm:py-4 glass-strong rounded-full font-semibold text-sm sm:text-base md:text-lg flex items-center gap-2 transition-all duration-300 ${theme === 'light' ? 'text-slate-800 bg-white/60 hover:bg-white/80 border border-blue-200' : 'text-white hover:bg-white/10'}`}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <Download size={20} className="hidden sm:block" />
              <Download size={18} className="block sm:hidden" />
              Download Resume
            </motion.a>
          </motion.div>
        </motion.div>
